...
Current repository evidence includes report `competitive-tui-20260610-360289b-clean-634d0394`, including workload `large-page-seek` and a comparator semantic matrix. It is local text-layout evidence for a clean commit, not a renderer benchmark, not a release guarantee, and not a broad speed claim.
