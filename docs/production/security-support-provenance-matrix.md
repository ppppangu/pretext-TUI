...
- Use report `competitive-tui-20260610-306debd-clean-fd7b8b9f` only as clean optional comparison evidence and preserve its JSON as the numeric source.
