...
- Use report `competitive-tui-20260610-360289b-clean-634d0394` only as clean optional comparison evidence and preserve its JSON as the numeric source.
