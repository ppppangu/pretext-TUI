...
- Use report `competitive-tui-20260610-5922fb2-clean-13df5d07` only as clean optional comparison evidence and preserve its JSON as the numeric source.
