...
- Use report `competitive-tui-20260610-125da72-clean-1aa6227c` only as clean optional comparison evidence and preserve its JSON as the numeric source.
