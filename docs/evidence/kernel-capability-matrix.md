...
Public capability claims should cite evidence IDs, commands, contracts, or tests. Timing values stay in JSON evidence reports, especially report `competitive-tui-20260610-360289b-clean-634d0394`.
...
- Cite report `competitive-tui-20260610-360289b-clean-634d0394` for optional local comparison evidence, and leave timing values in the JSON.
