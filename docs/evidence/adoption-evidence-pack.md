...
```text
See clean evidence report competitive-tui-20260610-125da72-clean-1aa6227c for raw samples, provenance metadata, workload ids, and semantic caveats.
```
