...
```text
See clean evidence report competitive-tui-20260610-306debd-clean-fd7b8b9f for raw samples, provenance metadata, workload ids, and semantic caveats.
```
