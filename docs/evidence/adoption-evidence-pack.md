...
```text
See clean evidence report competitive-tui-20260614-8bb092d-clean-054adcee for raw samples, provenance metadata, workload ids, and semantic caveats.
```
