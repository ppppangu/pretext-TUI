...
```text
See clean evidence report competitive-tui-20260610-5922fb2-clean-13df5d07 for raw samples, provenance metadata, workload ids, and semantic caveats.
```
