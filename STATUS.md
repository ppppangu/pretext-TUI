...
This repository has a `0.1.0-alpha.0` release-candidate `pretext-TUI` terminal-cell text layout package. Active work keeps the package host-neutral while tightening API boundaries, production/security posture, benchmark evidence, performance telemetry, and append-storage evidence.
